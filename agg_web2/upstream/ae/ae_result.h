#ifndef AGGWEB2_UPSTREAM_AE_RESULT_H
#define AGGWEB2_UPSTREAM_AE_RESULT_H
...
AGG_TYPEDEF_PTR(AeResult);

AGG_END_NAMESPACE(agg_web2);
BOOST_CLASS_EXPORT_KEY(AGG_NS(agg_web2)::AeResult);
