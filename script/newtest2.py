...
def createTestClassH(path, classname):
    ...
    if not ns:
        return False
    context = ""
    context = context + "#ifndef " + rootName.upper() + "_" + ns.upper() + "_" + classname.upper() + "TEST_H" + "\n"
    context = context + "#define " + rootName.upper() + "_" + ns.upper() + "_" + classname.upper() + "TEST_H" + "\n"
    context = context + "" + "\n"
    context = context + "#include <" + prjName + "/common/agg_common.h>" + "\n"
    context = context + "#include <" + prjName + "/" + hp + "/" + classname + ".h>" + "\n"
    context = context + "#include <cppunit/extensions/HelperMacros.h>" + "\n"
    context = context + "" + "\n"
    context = context + "AGG_BEGIN_NAMESPACE(" + ns + ");" + "\n"
    context = context + "" + "\n"
    context = context + "class " + getClassName(classname) + "Test : public CppUnit::TestFixture {" + "\n"
    ...
    context = context + "};" + "\n"
    context = context + "" + "\n"
    context = context + "AGG_END_NAMESPACE(" + ns + ");" + "\n"
    context = context + "" + "\n"
    context = context + "#endif //" + rootName.upper() + "_" + ns.upper() + "_" + classname.upper() + "TEST_H" + "\n"
...
def createTestClassCPP(path, classname):
    ...
    if not ns:
        return False
    context = ""
    context = context + "#include <" + prjName + "/" + hp + "/test/" + classname + "_unittest.h>" + "\n"
    context = context + "#include <cppunit/TestAssert.h>" + "\n"
    context = context + "" + "\n"
    context = context + "AGG_BEGIN_NAMESPACE(" + ns + ");" + "\n"
    context = context + "AGG_LOG_SETUP(" + ns + ", " + getClassName(classname) + "Test);" + "\n"
    context = context + "" + "\n"
    ...
    context = context + "{" + "\n"
    context = context + "    AGG_LOG(INFO, \"" + getClassName(classname) + "Test setUp\\n\");" + "\n"
    context = context + "}" + "\n"
    context = context + "" + "\n"
    context = context + "void " + getClassName(classname) + "Test::tearDown()" + "\n"
    context = context + "{" + "\n"
    context = context + "    AGG_LOG(INFO, \"" + getClassName(classname) + "Test tearDown\\n\\n\");" + "\n"
    context = context + "}" + "\n"
    context = context + "" + "\n"
