...
def createClassH(path, classname):
    ...
    context = context + "};" + "\n"
    context = context + "" + "\n"
    context = context + "typedef std::tr1::shared_ptr<" + getClassName(classname) + "> " + getClassName(classname) + "Ptr;\n\n"
    context = context + "A4_END_NAMESPACE(" + ns + ");" + "\n"
    context = context + "" + "\n"
    context = context + "#endif //" + prjName.upper() + "_" + ns.upper() + "_" + classname.upper() + "_H" + "\n"
...
def createClassCPP(path, classname):
    ...
    context = context + "" + "\n"
    context = context + "A4_BEGIN_NAMESPACE(" + ns + ");" + "\n"
    context = context + "A4_LOG_SETUP(" + ns + ", " + getClassName(classname) + ");" + "\n"
    context = context + "" + "\n"
