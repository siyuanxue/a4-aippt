#ifndef AGG_WEB2_BIZ_KNOWLEDGE_QLOG_RERANK_PROCESSOR_H
#define AGG_WEB2_BIZ_KNOWLEDGE_QLOG_RERANK_PROCESSOR_H
...
class QlogRerankProcessor : public BaseProcessor
{
public:
    QlogRerankProcessor();
    virtual ~QlogRerankProcessor();
...
AGG_TYPEDEF_PTR(QlogRerankProcessor);

AGG_END_NAMESPACE(agg_web2);

#endif //AGG_WEB2_BIZ_KNOWLEDGE_QLOG_RERANK_PROCESSOR_H
