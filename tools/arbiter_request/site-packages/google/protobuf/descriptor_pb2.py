...
_FIELDDESCRIPTORPROTO_TYPE = descriptor.EnumDescriptor(
  ...
  values=[
    ...
    descriptor.EnumValueDescriptor(
      ...
      type=None),
    descriptor.EnumValueDescriptor(
      name='TYPE_RAW_STRING', index=18, number=100,
      options=None,
      type=None),
  ],
